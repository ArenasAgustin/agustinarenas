...
- C:\Users\agusk\.gemini\skills
- C:\Users\agusk\.gemini\antigravity\skills
- C:\Users\agusk\.cursor\skills
...
### accessibility
- Path: D:\Programacion\portfolio\.agents\skills\accessibility\SKILL.md
- Rules:
...
### astro
- Path: D:\Programacion\portfolio\.agents\skills\astro\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### branch-pr
- Path: C:\Users\agusk\.config\opencode\skills\branch-pr\SKILL.md
...
### caveman
- Path: C:\Users\agusk\.agents\skills\caveman\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### chained-pr
- Path: C:\Users\agusk\.config\opencode\skills\chained-pr\SKILL.md
...
- Path: C:\Users\agusk\.config\opencode\skills\cognitive-doc-design\SKILL.md
...
### comment-writer
- Path: C:\Users\agusk\.config\opencode\skills\comment-writer\SKILL.md
...
### deploy-to-vercel
- Path: D:\Programacion\portfolio\.claude\skills\deploy-to-vercel\SKILL.md
...
### find-skills
- Path: C:\Users\agusk\.agents\skills\find-skills\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### frontend-design
- Path: D:\Programacion\portfolio\.agents\skills\frontend-design\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: C:\Users\agusk\.config\opencode\skills\go-testing\SKILL.md
...
### issue-creation
- Path: C:\Users\agusk\.config\opencode\skills\issue-creation\SKILL.md
...
### judgment-day
- Path: C:\Users\agusk\.config\opencode\skills\judgment-day\SKILL.md
...
- Path: D:\Programacion\portfolio\.claude\skills\nodejs-backend-patterns\SKILL.md
...
### seo
- Path: D:\Programacion\portfolio\.agents\skills\seo\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: C:\Users\agusk\.config\opencode\skills\skill-creator\SKILL.md
...
- Path: D:\Programacion\portfolio\.agents\skills\tailwind-css-patterns\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### typescript-advanced-types
- Path: D:\Programacion\portfolio\.agents\skills\typescript-advanced-types\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### vercel-react-best-practices
- Path: C:\Users\agusk\.agents\skills\vercel-react-best-practices\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### vite
- Path: D:\Programacion\portfolio\.claude\skills\vite\SKILL.md
...
### work-unit-commits
- Path: C:\Users\agusk\.config\opencode\skills\work-unit-commits\SKILL.md
